...
func _ready() -> void:
	...
	bullet_prices[Globals.Bullets.Ricochet] = "18 for $15"
	bullet_prices[Globals.Bullets.Shotgun] = "18 for $15"
	bullet_prices[Globals.Bullets.Explosive] = "18 for $15"
	bullet_prices[Globals.Bullets.Health] = "1 for $10"
	bullet_prices[Globals.Bullets.Railgun] = "12 for $20"
	bullet_prices[Globals.Bullets.Gambler] = "18 for $20"
